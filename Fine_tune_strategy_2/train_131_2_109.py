...
def args_parser():
    ...
    parser.add_argument(
        ...
        default="/data1/zhq/TL_framework/Direct_deploy_1_resnet/checkpoints/20240511_144459/1234/MHResAttNet-131-20240511_144459-epoch=11-val_loss=1.54-val_acc=0.88.ckpt", # 这是我去掉131和109这两个数据集之后训练得到的模型

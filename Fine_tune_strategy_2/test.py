...
model = ParametersClassifier.load_from_checkpoint(
    ...
    checkpoint_path="/home/data/ZHQ/DANN_24/TL_framework/Fine_tune_strategy_2/checkpoints/20240419_133132/1234/MHResAttNet-print131_to_109-20240419_133132-epoch=02-val_loss=2.42-val_acc=0.75.ckpt", # 这是我去掉131和109这两个数据集之后训练得到的模型
    num_classes=3,
    lr=INITIAL_LR,
    gpus=1,
    transfer=False,

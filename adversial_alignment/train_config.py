...
NUM_NODES = 1
NUM_GPUS = 1
TRANFER_Weight = 0.01 # 迁移学习权重，0.1,0.5,1,2,5,10
ONly_source = False# True只加载训练集数据，并对该数据做训练集和测试集划分，False：同时加载源域和目标域数据

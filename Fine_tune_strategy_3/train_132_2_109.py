...
os.environ["CUDA_VISIBLE_DEVICES"] = "2" # 一定要对应修改GPU_NUM
...
def args_parser():
    ...
    parser.add_argument(
        ...
        default="/data1/zhq/TL_framework/Direct_deploy_1_resnet/checkpoints/20240511_143032/1234/MHResAttNet-132-20240511_143032-epoch=07-val_loss=2.28-val_acc=0.81.ckpt", # 这是我去掉131和109这两个数据集之后训练得到的模型

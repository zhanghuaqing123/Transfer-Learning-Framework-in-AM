...
os.environ["CUDA_VISIBLE_DEVICES"] = "3" # 一定要对应修改GPU_NUM
...
def args_parser():
    ...
    parser.add_argument(
        "-c",
        "--checkpoint_path",
        # default="/home/data/ZHQ/DANN_24/TL_framework/Fine_tune_strategy_1/checkpoints/20240419_100958/1234/MHResAttNet-print131-20240419_100958-epoch=12-val_loss=1.65-val_acc=0.88.ckpt",
        # default="",   #不使用任何预训练模型
        # default="/data1/zhq/TL_framework/Direct_deploy_1_resnet/checkpoints/20240420_105104/1234/MHResAttNet-131-20240420_105104-epoch=10-val_loss=1.43-val_acc=0.89.ckpt",
        # 这是我去掉131和109这两个数据集之后训练得到的模型
        default="/data1/zhq/TL_framework/Direct_deploy_1_resnet/checkpoints/20240511_143032/1234/MHResAttNet-132-20240511_143032-epoch=08-val_loss=2.33-val_acc=0.81.ckpt", # 这是我去掉131和109这两个数据集之后训练得到的模型
        # default="/data1/zhq/TL_framework/Direct_deploy_1_resnet/checkpoints/20240420_133423/1234/MHResAttNet-109-20240420_133423-epoch=08-val_loss=1.54-val_acc=0.88.ckpt",
        # default="",   #不使用任何预训练模型
        type=str,
        help="Path to a model checkpoint to resume training"
    )

...
def args_parser():
    ...
    parser.add_argument(
        "-c",
        "--checkpoint_path",
        default="/data1/zhq/TL_framework/Direct_deploy_1_resnet_3_stage_train/checkpoints/20240518_093511/1234/MHResAttNet-dataset_single_layer-20240518_093511-epoch=13-val_loss=0.33-val_acc=0.97.ckpt",
        # default="",   #不使用任何预训练模型
        type=str,
        help="Path to a model checkpoint to resume training"
    )

...
model = ParametersClassifier.load_from_checkpoint(
    ...
    checkpoint_path="/home/data/ZHQ/DANN_24/TL_framework/Fine_tune_strategy_1/checkpoints/20240419_130700/1234/MHResAttNet-print131_to_109-20240419_130700-epoch=13-val_loss=4.05-val_acc=0.50.ckpt", # 这是我去掉131和109这两个数据集之后训练得到的模型
    num_classes=3,
    lr=INITIAL_LR,
    gpus=1,
    transfer=False,
